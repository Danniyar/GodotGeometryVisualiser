...
func _ready():
	...
	points[4].position.x = 0.05
	points[4].position.y = 0.1
	points[4].position.z = 0.05
	...
	get_node('/root/Node3D/VectorsManager')._on_create_pressed(points[1], points[4])
	get_node('/root/Node3D/VectorsManager')._on_create_pressed(points[2], points[4])
	get_node('/root/Node3D/VectorsManager')._on_create_pressed(points[3], points[4])
	
	name = "4 Sided Pyramide " + points[0].name + points[1].name + points[2].name + points[3].name + points[4].name
	updateData()
...
func _on_width_value_changed(value):
	...
	if points[4] != null:
		points[4].position.x = points[0].posX+(points[2].posX-points[0].posX)/2
		points[4].posX = points[4].position.x
		points[4].updateData()
...
func _on_length_value_changed(value):
	...
	if points[4] != null:
		points[4].position.z = points[0].posZ+(points[2].posZ-points[0].posZ)/2
		points[4].posZ = points[4].position.z
		points[4].updateData()
